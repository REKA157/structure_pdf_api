...
def generate_structural_plan(structure, dimensions, ferraillage, output_path):
    ...
    if structure == "poutre":
        ...
        # Trait sous poutre avec "< >", texte au milieu
        ...
        # Aciers longitudinaux + flèche verticale (nb HA)
        ...
        # Flèche diagonale depuis contour béton vers texte acier longitudinal
        ...
        # Cotations du rectangle : largeur B et hauteur H
        # Largeur (haut)
